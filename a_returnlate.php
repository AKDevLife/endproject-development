...
<body style="background-color: #91AFA8">
    <div class="container-fluid">
        ...
        <div class="menu">
            ...
            <main class="form">
                <div class="box">
                    <h2>รายชื่อที่เกินกำหนดการคืนประจำวันที่ <?php echo date("d-m-Y") ?></h2>
                    <hr class="s1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div id="popup<?php echo $i; ?>" class="overlay">
                                            <div class="popup">
                                                <h2>รายการอุปกรณ์ที่ทำการยืม</h2>
                                                <a class="close" href="a_returnlate.php">&times;</a>
                                                <div class="content">
                    ...
                    <a href="function/a_returnlatedownload.php" class="d1">download</a>
