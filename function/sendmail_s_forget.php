...
$subject = "Reset Password"; // หัวข้อเมล์
		...
		<body>
			...
			<div style='padding:20px;'>
				...
				<div>				
					 ...
					 <a href='http://localhost/EndProject/s_newPassword.php?key=".$email."&reset=".$pass."' target='_blank'>
						<h2><strong style='color:#3c83f9;'> >> คลิ๊กที่นี่ เพื่อเข้าหน้าเปลี่ยนรหัส << </strong> </h2>
					</a>
				</div>
